...
>> You can get
   a detailed usage message by executing:
>>>  sip2ncid `--help`
...
>   The smart phone needs to be running Remote Notifier for Android from:
    https://play.google.com/store/apps/details?name=org.damazio.notifier&hl=en
...
>   (The main web site for the android-notifier project is located at
    https://code.google.com/p/android-notifier, however, you do not need
    to download anything from there. You only need the app from Google Play.)
...
> After modifying **ncidd.conf** and **yac2ncid.conf**, you must start/restart ncidd
  first and then the yac2ncid gateway.
